import React, { useState, useRef } from "react";
  ...
  const THEMES = [
    { name: "White", nameT: "ขาว", primary: "#F5B800", bg: "#F5F5F0", card: "#FFFFFF", headerText: "#1A1A1A", textMain:
  "#1A1A1A", textSub: "#555", border: "#CCC" },
  ...
  const lang = {
    en: {
      ...
      selectDay: "Select your activity", selectHint: "Select one or both",
      ...
      scorecard: "Scorecard (image or PDF)",
      swingVideo: "Swing Video URL", swingVideoPh: "e.g. https://drive.google.com/...",
      introVideo: "Self-Introduction Video URL", introVideoPh: "e.g. https://youtu.be/...",
    ...
    th: {
      ...
      title: "beat the pro", subtitle: "Junior Activity Registration",
      saturday: "Saturday", sunday: "Sunday",
      selectDay: "เลือกกิจกรรม", selectHint: "เลือกหนึ่งหรือทั้งสองรายการ",
      ...
      scorecard: "สกอร์การ์ด (ภาพหรือ PDF)",
      swingVideo: "URL วิดีโอการสวิง", swingVideoPh: "เช่น https://drive.google.com/...",
      introVideo: "URL วิดีโอแนะนำตัว", introVideoPh: "เช่น https://youtu.be/...",
  ...
  const css = [
    ...
    "@keyframes breathe{0%{transform:scale(1);opacity:0.85}50%{transform:scale(1.18);opacity:1}100%{transform:scale(1);o
  pacity:0.85}}",
  ...
  function Anim({ cls = "fade-up", delay = 0, style, children }) {
    return (
      <div className={cls} style={{ animationDelay: delay + "s", ...style }}>
        {children}
      </div>
    );
  }
  ...
  function SectionDivider({ label, c }) {
    return (
      <div style={{
        fontSize: 10, color: c.primary, letterSpacing: 2,
        textTransform: "uppercase", fontWeight: 700,
        marginBottom: 12, marginTop: 8, paddingBottom: 6,
        borderBottom: "1px solid " + c.primary + "44",
      }}>
        {label}
      </div>
    );
  ...
  function Input({ label, placeholder, type = "text", value, onChange, error, c }) {
    const borderColor = error ? "#E55" : value ? c.primary : c.border;
    return (
      <div style={{ marginBottom: 14 }}>
        ...
        <input
          ...
          style={{
            ...
            border: "2px solid " + borderColor, fontSize: 15,
            background: "rgba(128,128,128,0.08)", color: c.textMain, outline: "none",
          }}
        />
        {error && (
          <div className="fade-in" style={{ fontSize: 12, color: "#E55", marginTop: 5 }}>
            ! {error}
          </div>
        )}
      </div>
      ...
      <div style={{ marginBottom: 14 }}>
        ...
        <div style={{ display: "flex", gap: 8 }}>
          {options.map(opt => {
            ...
            const borderColor = sel ? c.primary : error ? "#E55" : c.border;
            const bg = sel ? c.primary + "18" : "rgba(128,128,128,0.08)";
            return (
              <div
                key={opt.value}
              ...
              >
                ...
                <div style={{
                  ...
                  color: sel ? c.primary : c.textMain, lineHeight: 1.3,
                }}>
                  {opt.label}
                </div>
              </div>
  ...
  function FileUpload({ label, value, onChange, error, c }) {
    const ref = useRef();
    const borderColor = error ? "#E55" : value ? c.primary : c.border;
    const bg = value ? c.primary + "18" : "rgba(128,128,128,0.08)";
    return (
      <div style={{ marginBottom: 14 }}>
        <label style={{ fontSize: 12, color: c.textSub, display: "block", marginBottom: 6 }}>
          {label} <span style={{ color: "#E55" }}>*</span>
        ...
        <div
          ...
          style={{
            ...
            gap: 12, cursor: "pointer", background: bg, transition: "all 0.25s",
          }}
        >
          <span style={{
            fontSize: 13,
            color: value ? c.primary : error ? "#E55" : c.textSub,
            fontWeight: value ? 600 : 400,
          }}>
            {value ? value.name : label}
          </span>
          <input
            ref={ref} type="file" accept="*/*"
            style={{ display: "none" }}
  ...
  export default function App() {
    ...
    const btnP = {
      ...
      background: c.primary, color: c.headerText, fontSize: 14,
      fontWeight: 700, cursor: "pointer", letterSpacing: 1.5, transition: "all 0.2s",
    };
    ...
    const certOpts = [
      { value: "yes", label: t.certYes },
      { value: "no", label: t.certNo },
    ];
    ...
    return (
      <div style={{ background: c.bg, minHeight: "100vh", fontFamily: "Arial,sans-serif" }}>
        ...
        {step === -1 && (
          <div
            className={splashOut ? "fade-out" : "fade-in"}
            style={{
          ...
          >
            <Anim cls="pop-in" delay={0.1}>
              <div className="breathe" style={{ fontSize: 72, marginBottom: 24 }}>G</div>
            </Anim>
  ...
  marginBottom: 8 }}>
            ...
            <Anim cls="fade-up" delay={0.5} style={{ width: "100%", maxWidth: 360 }}>
              <button
                ...
                style={{ ...btnP, width: "100%", fontSize: 16, padding: "18px", letterSpacing: 4, borderRadius: 14 }}
            ...
            <Anim cls="fade-up" delay={0.7}>
              <div className="shimmer" style={{ fontSize: 12, color: "#555", marginTop: 24, letterSpacing: 1 }}>
        ...
        {showLangPicker && (
          ...
          >
            <div
              className="pop-in"
              style={{
                background: c.card, borderRadius: 24, padding: "36px 32px",
                textAlign: "center", width: 300, border: "2px solid " + c.primary,
              }}
            >
  ...
  textTransform: "uppercase" }}>
              ...
              <div style={{ display: "flex", gap: 20, justifyContent: "center" }}>
                {[
                  { code: "en", label: "English", sublabel: "อังกฤษ", flag: ukFlag },
                  { code: "th", label: "ภาษาไทย", sublabel: "Thai", flag: thFlag },
                ].map(opt => {
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        alignItems: "center", gap: 10, padding: "14px 18px", borderRadius: 16,
                        border: "2px solid " + (sel ? c.primary : "transparent"),
                        background: sel ? c.primary + "18" : "transparent", transition: "all 0.2s",
                      }}
                    >
                      <div style={{ boxShadow: "0 2px 8px rgba(0,0,0,0.25)", borderRadius: 6 }}>
                        {opt.flag}
                      </div>
  ...
  20px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 8 }}>
                <div style={{
                  display: "flex", background: "rgba(128,128,128,0.15)",
                  ...
                  {["en", "th"].map(l => (
                    <button
                      ...
                      style={{
                        ...
                        fontWeight: 700, background: language === l ? c.primary : "transparent",
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 20, padding: "4px 10px", color: c.textSub,
            ...
            {showTheme && (
              <div className="fade-up" style={{ display: "flex", gap: 8, marginTop: 12 }}>
                {THEMES.map((th, i) => (
                  <button
                    key={i}
                    onClick={() => { setThemeIdx(i); setShowTheme(false); }}
                    style={{
                      background: th.primary,
                      border: i === themeIdx ? "2px solid " + (i === 0 ? "#333" : "#FFF") : "2px solid transparent",
                      borderRadius: 20, padding: "5px 14px", color: th.headerText,
                      fontSize: 12, cursor: "pointer", fontWeight: 700,
                    }}
                  >
                    {language === "th" ? th.nameT : th.name}
                  </button>
                ))}
              </div>
            )}
  ...
  marginBottom: 2 }}>
                ...
                {[
                  { label: t.saturday, details: SAT_DETAILS },
                  { label: t.sunday, details: SUN_DETAILS },
                ].map((item, idx) => {
                  ...
                  return (
                    <Anim key={item.label} cls="fade-up" delay={idx * 0.1}>
                      <div
                        ...
                        style={{
                          background: sel ? c.primary + "14" : c.card,
                          borderRadius: 18, marginBottom: 14, cursor: "pointer",
                      ...
                      >
                        <div style={{ display: "flex", alignItems: "center", gap: 16, padding: "16px 18px" }}>
                          <div style={{
                            ...
                            background: sel ? c.primary : (c.bg === "#F5F5F0" ? "#EEE" : "#333"),
                            display: "flex", alignItems: "center", justifyContent: "center",
                          ...
                          <div style={{ flex: 1 }}>
                            ...
                            <div style={{ fontSize: 11, color: c.textSub, letterSpacing: 1 }}>
                              JUNIOR ACTIVITY - all Thailand GOLF TOUR
                            </div>
                          </div>
                          <div style={{ fontSize: 20, color: c.primary, fontWeight: 900 }}>
                            {sel ? "x" : "+"}
                          </div>
                        </div>
                        {sel && (
                          <div
                            className="expand-in"
                            style={{ borderTop: "1px solid " + c.primary + "44", padding: "14px 18px 16px" }}
                          >
                            {item.details.map((d, i) => (
                              <DetailLine key={i} item={d} color={c.textMain} />
                            ))}
                          </div>
                        )}
                      </div>
                ...
                {errors.days && (
                  <div className="fade-in" style={{ fontSize: 12, color: "#E55", marginBottom: 10 }}>
                    ! {errors.days}
                  </div>
                )}
                <button style={{ ...btnP, width: "100%" }} onClick={() => tryNext(0, 1)}>
                  {t.next} &gt;
                </button>
              </div>
            )}
  ...
  onChange={v => setF("introVideo", v)} error={errors.introVideo} c={c} />
                ...
                <div style={{ display: "flex", gap: 10 }}>
                  ...
                  <button
                    style={{ ...btnP, flex: 2, opacity: submitting ? 0.7 : 1 }}
                ...
                {submitError && (
                  <div className="fade-in" style={{ fontSize: 12, color: "#E55", marginTop: 10, textAlign: "center" }}>
                    ! {submitError}
                  </div>
                )}
              </div>
            ...
            {step === 4 && (
              <div key={animKey} style={{ textAlign: "center" }}>
                <Anim cls="pop-in" delay={0.1}>
                  <div style={{
                    width: 80, height: 80, borderRadius: "50%", background: c.primary,
                    ...
                    {[
                      ...
                      <div
                        ...
                        style={{
                          ...
                          fontSize: 13, borderBottom: "1px solid " + c.border, padding: "10px 0",
                        }}
                      >
                ...
                <Anim cls="fade-up" delay={0.6}>
                  <button style={{ ...btnP, width: "100%", marginTop: 8 }} onClick={resetForm}>
                    {t.registerAnother}
                  </button>
                </Anim>
              </div>
